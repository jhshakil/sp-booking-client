    ...
    <div className="border-t border-border">
      <div className="container px-6 md:px-12 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
        <div className="mt-7 md:col-span-2">
          <p>
            A sports facility is a dedicated space designed for various athletic
            activities, recreational sports, and fitness programs. These
            facilities can vary greatly in size, amenities, and the types of
            sports they accommodate.
          </p>
        </div>
        <div>
